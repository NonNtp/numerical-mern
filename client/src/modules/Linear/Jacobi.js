...
const JacobiMethod = (
	...
	while ((Error1 && Error2 && Error3 && Error4) > EPSILON_JACOBI) {
		newX1 = (b1 - a12 * x2) / a11
		newX2 = (b2 - a21 * x1 - a23 * x3) / a22
		newX3 = (b3 - a32 * x2 - a34 * x4) / a33
		newX4 = (b4 - a43 * x3) / a44
		...
		console.log(`i ${i} : x1 = ${newX1}`)
		console.log(`i ${i} : E1 = ${Error1}`)
		console.log(`i ${i} : x2 = ${newX2}`)
		console.log(`i ${i} : E2 = ${Error2}`)
		console.log(`i ${i} : x3 = ${newX3}`)
		console.log(`i ${i} : E3 = ${Error3}`)
		console.log(`i ${i} : x4 = ${newX4}`)
		console.log(`i ${i} : E4 = ${Error4}`)
		console.log('-------------------------')
		i++
	}
	return [
