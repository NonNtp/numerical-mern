...
import { FalsePositionMethod } from '../../modules/Root/FalsePosition'
...
const FalsePosition = () => {
	...
	const submitHandler = (event) => {
		...
		setResult(FalsePositionMethod(enteredEquation, xlNumber, xrNumber))
		setShowGraph(true)
	}
	...
	return (
		<div>
			<div className='flex-app'>
				<div className='app'>
					<h1 className='false-position'>FalsePosition</h1>

					<form onSubmit={submitHandler}>
						<div className='control-group'>
							<div className='form-control'>
								<label htmlFor='xr'>Equation FalsePosition</label>
