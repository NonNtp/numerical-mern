...
import { NewtonMethod } from '../../modules/Root/Newton'
import './Root.css'
...
const OnePoint = () => {
	...
	const submitHandler = (event) => {
		...
		setResult(NewtonMethod(enteredEquation, xmNumber, iteration))
	...
	return (
		<div>
			<div className='flex-app'>
				<div className='app'>
					<h1 className='bisection'>Newton Raphson</h1>
					<form onSubmit={submitHandler}>
						<div className='control-group'>
							<div className='form-control'>
								<label htmlFor='xr'>Equation Newton Raphson</label>
